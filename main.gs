function doGet(e) {
  try {
    ...
    // 返すべきファイルを決定
    let content = '';
    let mimeType = ContentService.MimeType.TEXT_PLAIN; // デフォルトは text/plain
...
/**
 * 複数のJavaScriptファイルの内容を返すエンドポイント
 * クエリパラメータ 'file' によって返す内容を分岐
 * 例: https://script.google.com/macros/s/AKfycbzq3tlYtz0rfCxwVUYSKebw5Z75w5lamlTLcigT0w_jGHRNy1sko8AhnqOc8UF0mHfvcw/exec?file=script.js
 * https://script.google.com/macros/s/AKfycbzq3tlYtz0rfCxwVUYSKebw5Z75w5lamlTLcigT0w_jGHRNy1sko8AhnqOc8UF0mHfvcw/exec
 */
